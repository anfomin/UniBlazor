...
public static class NavigationExtensions
{
	...
	/// </summary>
	public static bool IsPathEndsWith(this NavigationManager navigation, string suffix)
	...
	/// </summary>
	public static string GetLocalUri(this NavigationManager navigation)
	...
	public static string GetUriPreservingQuery(this NavigationManager navigation, [StringSyntax(StringSyntaxAttribute.Uri)] string path)
	{
	...
	public static string GetUriPreservingQuery(this NavigationManager navigation, [StringSyntax(StringSyntaxAttribute.Uri)] string path, IReadOnlyDictionary<string, object?> parameters)
	{
		NavParams query = [];
	...
	public static void NavigatePreservingQueryTo(this NavigationManager navigation, [StringSyntax(StringSyntaxAttribute.Uri)] string path, IReadOnlyDictionary<string, object?>? parameters = null)
	...
	/// </summary>
	/// <param name="parameters">New query parameters.</param>
	public static void NavigateToParams(this NavigationManager navigation, IReadOnlyDictionary<string, object?> parameters)
	...
	public static void NavigateToParam(this NavigationManager navigation, string name, string? value)
	{
	...
	/// <param name="name">New query parameter name.</param>
	/// <param name="value">Query parameter value.</param>
	public static void NavigateToParam(this NavigationManager navigation, string name, int? value)
	{
	...
	/// <param name="name">New query parameter name.</param>
	/// <param name="value">Query parameter value.</param>
	public static void NavigateToParam(this NavigationManager navigation, string name, bool value)
	...
	/// <param name="name">New query parameter name.</param>
	/// <param name="value">Query parameter value.</param>
	public static void NavigateToParam(this NavigationManager navigation, string name, DateOnly? value)
	...
	/// <param name="name">New query parameter name.</param>
	/// <param name="value">Query parameter value.</param>
	public static void NavigateToParam(this NavigationManager navigation, string name, object? value)
	...
	static string? ConvertParameterValue(object? value) => value switch
	{
		...
		var v when v.GetType().IsEnum => ((int)v).ToString(CultureInfo.InvariantCulture),
		_ => value.ToString()
	};
}